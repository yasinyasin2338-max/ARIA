...
const fields = {
  ...
  slack: ['Choose the Slack workspace you want to connect', 'OAuth Redirect URL: '+origin+'/api/oauth/slack/callback', 'Bot Token Scopes: channels:read, users:read', 'No message-write scope is required by the current Hub Slack tool'],
